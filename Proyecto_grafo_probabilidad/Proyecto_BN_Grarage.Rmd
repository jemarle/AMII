...
```{r bn_creation, include = T, fig.cap = capFig("Red bayesiana con probabilidades a priori", y = "bn_creation"), fig.align = "center", fig.pos = "H"}
