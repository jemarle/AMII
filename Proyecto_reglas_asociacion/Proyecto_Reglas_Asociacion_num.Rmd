...
pacman::p_load(readr, stringr, tidyr, dplyr, readxl, ggplot2, forcats, kableExtra, greekLetters, fitdistrplus, OneR, caret, OneR, arules, arulesCBA, arulesViz, Rgraphviz, DescTools, vcd)
```
...
```{r grafico_frecuencias_porcentajes, include = T}
...
```{r llamada_plots_diferencia, include = T}
...
for (method in methods){
  ...
  title(main = paste("PlotCorr para el método", method), line = -18)
}
